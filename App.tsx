            ...
            <div ref={scrollRef} className="flex-1 overflow-y-auto p-6 space-y-6 bg-[#0a0a0a] no-scrollbar">
              ...
              {showLeadForm && (
                <motion.div 
                  ...
                  className="bg-indigo-600/5 p-6 rounded-3xl border border-indigo-500/20 shadow-sm"
                >
  ...
  if (isSuccess) {
    return (
      <div className="text-center py-4">
        ...
        <h4 className="font-bold text-white mb-1 uppercase tracking-tight">Success!</h4>
        <p className="text-zinc-500 text-[10px] uppercase tracking-widest">We'll be in touch shortly.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        <h4 className="font-bold text-xs text-white uppercase tracking-widest">Request a Demo</h4>
      </div>
      <input
        required
        type="text"
        placeholder="Name"
        className="w-full p-3 rounded-xl border border-white/10 text-sm focus:ring-1 focus:ring-indigo-500 bg-zinc-900 text-white placeholder:text-zinc-600"
        value={formData.name}
      ...
      <textarea
        placeholder="Inquiry"
        className="w-full p-3 rounded-xl border border-white/10 text-sm focus:ring-1 focus:ring-indigo-500 bg-zinc-900 text-white placeholder:text-zinc-600 h-20 resize-none"
      ...
      <button
        ...
        className="w-full bg-indigo-600 text-white py-3 rounded-xl font-bold text-xs hover:bg-indigo-700 transition-all disabled:opacity-50 uppercase tracking-widest"
      >
